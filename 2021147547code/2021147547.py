...
data3["TotalMatches"] = data3["Games_x"] + data3["Games_y"]
...
plt.subplot(121)
plt.pie(df1["v1"], explode=explode, labels=g, autopct="%3.1f%%", startangle=60, colors=c, wedgeprops=wedgeprops)
plt.title("Home Team Half and Full Match Result Distribution")
plt.subplot(122)
plt.pie(df2["v2"], explode=explode, labels=g1, autopct="%3.1f%%", startangle=60, colors=c1, wedgeprops=wedgeprops)
